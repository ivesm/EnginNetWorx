                ...
                <div className="flex flex-wrap gap-2">
                    ...
                    <div className="flex-[2]">
                        <div className="overflow-hidden bg-white shadow-md rounded-lg p-6">
                            ...
                            <div className={`grid grid-cols-1 md:grid-cols-12 gap-4 ${isVisible1 ? '' : 'hidden'}`}>
                            ...
                            <div className={`grid grid-cols-1 md:grid-cols-12 gap-4 ${isVisible2 ? '' : 'hidden'}`}>
                                ...
                                <div className="md:col-span-8">
                                    <input type="number" name="coefficientrestitution" id="coefficientrestitution" required
                                           step="any"
                                           className="w-full border rounded px-3 py-2 focus:outline-none focus:ring focus:ring-blue-300"
                                ...
                                <div className="md:col-span-3 flex items-center">
                                    <label htmlFor="potentialenergyhammer">Potential Energy of hammer in
                                        free fal</label>
                                </div>
                                <div className="md:col-span-8">
                                    <input type="number" name="potentialenergyhammer" id="potentialenergyhammer" required
                                           step="any" disabled
                                           className="w-full border rounded px-3 py-2 focus:outline-none focus:ring focus:ring-blue-300"
                                           placeholder="0"
                                ...
                                <div className="md:col-span-3 flex items-center">
                                    <label htmlFor="stresspilesdrivingforce">Stress in Piles due to Driving Force  &sigma;<sub>D</sub></label>
                                </div>
                                <div className="md:col-span-8">
                                    <input type="number" name="stresspilesdrivingforce" id="stresspilesdrivingforce" required
                                           step="any" disabled
                                           className="w-full border rounded px-3 py-2 focus:outline-none focus:ring focus:ring-blue-300"
                                           placeholder="0"
                                ...
                                <div className="md:col-span-1">
                                   <br>MPa </br>
                                    if  9.9 MPa , "Check Driving Type" , "Medium" = "Medium"
                                </div>
